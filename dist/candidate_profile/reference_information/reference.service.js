...
const reference_modal_1 = __importDefault(require("@/models/reference.modal"));
const services_1 = require("@/services");
const MODEL = reference_modal_1.default;
...
const handlerCreate = async (item) => {
     ...
     *
     */
    const result = await (0, services_1.baseCreateDocument)({
        document: { ...item },
        model: MODEL,
